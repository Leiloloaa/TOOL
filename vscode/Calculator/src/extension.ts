...
export function activate(context: vscode.ExtensionContext) {
  ...
  vscode.window
    ...
    .then(undefined, (error) => {
      if (error && (error as any)?.name !== "Canceled") {
  ...
  context.subscriptions.push(
    ...
    calculateCommand,
    replaceCommand,
    calculatorProvider.statusBarItem
  );
}
  ...
  implements vscode.HoverProvider, vscode.CodeLensProvider
{
  ...
  private findMathExpressionBeforeEquals(text: string): string | null {
  ...
  private findMathExpressionAfterEquals(text: string): string | null {
